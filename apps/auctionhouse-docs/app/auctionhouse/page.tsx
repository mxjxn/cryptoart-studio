...
export default function AuctionhouseHome() {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 font-mono">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-4 mb-16">
        <TerminalCard title="LISTING TYPES">
          ...
          <TerminalLink href="/auctionhouse/capabilities" className="text-sm uppercase">
            Learn more →
          </TerminalLink>
        </TerminalCard>
        ...
        <TerminalCard title="INTEGRATION GUIDE">
          ...
          <TerminalLink href="/auctionhouse/integration" className="text-sm uppercase">
            Learn more →
          </TerminalLink>
        </TerminalCard>
        ...
        <TerminalCard title="DEPLOYMENT">
          ...
          <TerminalLink href="/auctionhouse/deployment" className="text-sm uppercase">
            Learn more →
          </TerminalLink>
        </TerminalCard>
        ...
        <TerminalCard title="EXAMPLES">
          ...
          <TerminalLink href="/auctionhouse/examples" className="text-sm uppercase">
            Learn more →
          </TerminalLink>
        </TerminalCard>
      </div>
      ...
      <TerminalCard className="mb-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <TerminalCard className="text-center">
            ...
            <TerminalLink href="/auctionhouse/getting-started" className="text-xs mt-2 block">
              Open →
            </TerminalLink>
          </TerminalCard>
