 ...
 */
export const APP_NAME: string = 'auctionhouse';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'an auctionhouse mini-app for farcaster /cryptoart';
 ...
 */
export const APP_TAGS: string[] = ['nft', 'auction', 'art', 'cryptoart'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'Enter the Auctionhouse';
