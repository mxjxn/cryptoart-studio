...
const FarcasterConnectPage: React.FC = React.memo(() => {
                ...
                <div className="flex flex-col items-center pt-5 bg-app">
                  <div className="space-y-3 px-4 text-center">
                    ...
                    <div className="text-muted">
                      Tap the button below to open Farcaster and connect.
                    </div>
...
FarcasterConnectPage.displayName = 'FarcasterConnectPage';

export { FarcasterConnectPage };
