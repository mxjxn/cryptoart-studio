...
const getRedirectUrl = () => {
  ...
  const redirectUrl = new URL('farcaster://start-recovery');
  redirectUrl.searchParams.set('token', webUrl.searchParams.get('token') ?? '');
  redirectUrl.searchParams.set('email', webUrl.searchParams.get('email') ?? '');

  return redirectUrl.href;
};

const RecoveryStartPage: FC = memo(() => {
  useEffect(() => {
...
RecoveryStartPage.displayName = 'RecoveryStartPage';

export { RecoveryStartPage };
