...
type LinkToProfileStarterPacksWithUsernameProps = Omit<
  LinkProps<'profileStarterPacksWithUsername'>,
  'to' | 'searchParams'
> & {
  fid: number;
...
const LinkToProfileStarterPacksWithUsername: FC<LinkToProfileStarterPacksWithUsernameProps> =
  memo(({ includeReason, sourceOn, castHash, ...props }) => {
    ...
    return (
      <Link
        to="profileStarterPacksWithUsername"
        searchParams={{
...
LinkToProfileStarterPacksWithUsername.displayName =
  'LinkToProfileStarterPacksWithUsername';

export { LinkToProfileStarterPacksWithUsername };
