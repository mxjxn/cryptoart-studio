...
type LinkToProfileAssetsWithoutUsernameProps = Omit<
  LinkProps<'profileAssetsWithoutUsername'>,
  'to' | 'searchParams'
> & {
...
const LinkToProfileAssetsWithoutUsername: FC<LinkToProfileAssetsWithoutUsernameProps> =
  memo(({ includeReason, sourceOn, castHash, ...props }) => {
    ...
    return (
      <Link
        to="profileAssetsWithoutUsername"
        searchParams={{
...
LinkToProfileAssetsWithoutUsername.displayName =
  'LinkToProfileAssetsWithoutUsername';

export { LinkToProfileAssetsWithoutUsername };
