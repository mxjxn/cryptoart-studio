    ...
    <div className="mx-auto w-full max-w-[424px] animate-frame-action-content-show rounded-xl border p-6 pb-4 bg-app border-default">
      <div className="flex w-full flex-col items-center space-y-4">
        <div className="relative">
          ...
          />
          <div className="absolute -right-2 -top-2 flex size-8 items-center justify-center rounded-full border-2 border-background bg-[#E5E0F3]">
            <span className="text-xl text-action-purple">+</span>
          </div>
        </div>
        <h3 className="text-center text-xl font-semibold">
          Add Mini App: {frame.name}
        </h3>
      </div>
