...
import { buildNotificationsInGroupFetcher } from './buildNotificationsInGroupFetcher';
import { buildNotificationsInGroupKey } from './buildNotificationsInGroupKey';

const useNotificationsInGroup = ({
  groupId,
  type,
}: {
  groupId: string;
  ...
  const result = useSuspenseInfiniteQuery({
    ...
    queryFn: buildNotificationsInGroupFetcher({
      apiClient,
...
export { useNotificationsInGroup };
