 ...
 */
export const APP_NAME: string = 'cryptoart-studio-app';

/**
 * A brief description of the mini app's functionality.
 * Used in app store listings and metadata.
 */
export const APP_DESCRIPTION: string = 'a frontend for the creator studio toolbox';
 ...
 */
export const APP_TAGS: string[] = ['nft', 'cryptoart', 'art'];
 ...
 */
export const APP_BUTTON_TEXT: string = 'cryptoart studio';
