...
export function ActionsTab() {
  ...
  // --- Render ---
  return (
    <div className="space-y-3 px-4 w-full max-w-sm mx-auto">
      {/* Share functionality */}
      <ShareButton
      ...
      <div className="space-y-2">
        ...
        <select
          ...
          className="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-800 text-gray-900 dark:text-gray-100 focus:outline-none focus:ring-2 focus:ring-primary text-sm"
        >
