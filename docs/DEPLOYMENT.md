...
- `NEXT_PUBLIC_AUCTIONHOUSE_SUBGRAPH_URL` - Auctionhouse subgraph (Base); Studio query URL (required)
- `NEXT_PUBLIC_AUCTIONHOUSE_SUBGRAPH_URL_MAINNET` - Same subgraph deployed for Ethereum mainnet (optional; required for dual-chain server features)
