...
// NOTE: Subscription and subscriber cache tables are commented out - focusing on basics (Creator Core & Auctionhouse)
// Uncomment when implementing subscription features
...
// NOTE: Airdrop tables are commented out - will be used later in subscriptions section
// Uncomment when implementing airdrop features
...
// NOTE: Clanker tokens table is commented out - not implemented yet
// Uncomment when implementing Clanker token features
